...
The `{nethack}` package currently on Github contains a dump from all the NetHack games played
on the alt.org/nethack public server. This data was kindly provided by [`@paxed`](https://twitter.com/paxed).
