...
I use the `map*` family of functions included in `purrr` (When I teach R, I only show loops in the
...
doing here, go read it [here](http://www.brodrigues.co/blog/2018-01-03-lists_all_the_way/)).
...
brilliant [`rio`](https://github.com/leeper/rio) package.
...
where you you want to apply your function. The following lines of code might help you understand:
...
Now for the last part; why doing all this, and not simply bind all the rows, apply `double_col()`
