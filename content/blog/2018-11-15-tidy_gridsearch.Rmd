...
one. In the case of univariate time series, I am still doubtful that a gridsearch like this is really necessary. Plus, I was not very rigorous and used the test set also as a validation set,
which you shouldn't do, because you might be overfitting the hyperparameters to the test set. The
goal of this blog post was not to teach you how to look for hyperparameters per se, but more to
show you to do a grid search the tidy way. I'll be talking about *proper* hyperparameter optimization
