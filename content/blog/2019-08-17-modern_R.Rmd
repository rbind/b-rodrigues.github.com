...
menu:
  main:
    parent: Blog
    identifier: /blog/modern_R
    weight: 1
---

<div style="text-align:center;">
  <a href="https://leanpub.com/modern_tidyverse">
    <img src="/img/cover_modern.png" title = "Click here to go to Leanpub" width="500" height="647"></a>
</div>

Yesterday I released an ebook on [Leanpub](https://leanpub.com/modern_tidyverse), 
called *Modern R with the tidyverse*, which you can also
read for free [here](https://b-rodrigues.github.io/modern_R/). 
...
[Functional programming and unit testing for data munging with R](https://leanpub.com/fput) around
Christmas 2016 (I've retired it on Leanpub, but you can still read it for free 
[here](https://b-rodrigues.github.io/fput/)) . I just had moved back to my home country of 
...
[modeling with functional programming](https://b-rodrigues.github.io/modern_R/functional-programming.html#modeling-with-functional-programming) 
...
[Leanpub](https://leanpub.com/modern_tidyverse). Unlike my previous ebook, this one costs money;
a minimum price of 4.99\$ and a recommended price of 14.99\$, but as mentioned you can read it for
free [online](https://b-rodrigues.github.io/modern_R/). I've hesitated to give it a minimum price of
