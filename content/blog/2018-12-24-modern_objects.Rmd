...
<div style="text-align:center;">
  <a href="https://www.youtube.com/watch?v=M-1nTwiHxic">
    <img width = "400" src="/img/santa_sanders.jpg" title = "The frydiest time of the year"></a>
</div>
...
free [here](https://b-rodrigues.github.io/modern_R/). This is taken from Chapter 2, which explains
...
```{r, echo=FALSE}
knitr::include_graphics("/img/rstudio_environment_list.gif")
```
...
```{r, echo=FALSE}
knitr::include_graphics("/img/rstudio_view_data.gif")
```
