...
Anyway, back to the point of this blog post. How can we get data from a pdf where no text recognition
...
github [page](https://github.com/tesseract-ocr/tesseract). `tesseract` is currently at version 4.
