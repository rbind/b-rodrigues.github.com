...
results. In any case, this was quite an interesting project, In the meantime, topic 1 is about shoes (`chaussures`) and farts (`pet`).
and learned a lot about topic modeling
