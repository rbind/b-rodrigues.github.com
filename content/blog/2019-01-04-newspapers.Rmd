...
cubic metre (see [Wikipedia](https://en.wikipedia.org/wiki/Stere)). For the other topics, I either
lack context or perhaps I just adjust `k`, the number of topics to model, and `alpha` to get better
results. In the meantime, topic 1 is about shoes (`chaussures`) and farts (`pet`).
In any case, this was quite an i, theatre, fuel (`combustible`)
teresting project. Really wonder what they were selling in that shop. I learned a lot about topic modeling
