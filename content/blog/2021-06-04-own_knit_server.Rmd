...
in the encrypted `.Rmd` script and get back an encrypted `.pdf` file. Dear reader, you surely think
...
## An API that ingests and Rmd file and spits out a compiled document
