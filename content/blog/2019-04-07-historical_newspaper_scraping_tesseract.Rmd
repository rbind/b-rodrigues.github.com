...
pages I am interested in are page 3, which contain the tables I'm interested in, for example 
...
the download links can be obtained using [@yvesmaurer](https://twitter.com/yvesmaurer)'s code. This code only downloads
