...
main:
  parent: Blog
  identifier: /blog/shiny_raspberry
  weight: 1
---

<div style="text-align:center;">
<a href="https://www.youtube.com/watch?v=2mSEEHblJqw">
  <img src="/img/virgin_chad.png" title = "Not everyone can be a chad shiny dev"></a>
</div>


This blog post will not have any code, but will document how I went from hosting apps
on [shinyapps.io](https://www.shinyapps.io) to hosting shiny apps on my own server, which is a Raspberry Pi 4B with 8 gigs of ram.
First of all, why hosting apps on a Raspberry Pi? And why not continue on [shinyapps.io](https://www.shinyapps.io)?
...
I found a Github repository from user `havlev` that explains how to do it [here](https://github.com/hvalev/rpi-shiny-server-docker).
...
that you can find [here](http://shinybrodriguesco.duckdns.org:3838/golemDemo/). I'll also give you 
...
So let's suppose that you're me a few weeks ago, and that you find and follow `havlev`'s guide [here](https://github.com/hvalev/rpi-shiny-server-docker).
...
followed [this guide](https://ropenscilabs.github.io/r-docker-tutorial/03-install-packages.html). 
...
dynamic DNS. I use [duckdns](https://www.duckdns.org/). This will allow you to have domain that you
can share with the world. What's nice is that if you follow their [guide](https://www.duckdns.org/install.jsp)
...
which you can find [here](http://shinybrodriguesco.duckdns.org:3838/golemDemo/).
