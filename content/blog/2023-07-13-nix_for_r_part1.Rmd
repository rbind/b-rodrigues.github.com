...
by Nix ([cache.nixorg.org](https://cache.nixos.org/)) for fast installations. If
...
- There is no easy way (afaik) to find the version of `nixpkgs` that you need to download to find the version of R that you may need;
...
Many thanks to [Justin Bedő](https://github.com/jbedo), maintainer of the R
